    ...
    <View style={[styles.container, { paddingTop: insets.top, paddingBottom: insets.bottom }]}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.banner}>
          ...
          <Text style={styles.bannerTitle}>Video Content</Text>
          <Text style={styles.bannerText}>Videos can be uploaded and managed through the admin panel</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  videoCard: { flexDirection: 'row', backgroundColor: Colors.white, borderRadius: 14, padding: 14, marginBottom: 10, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.04, shadowRadius: 4, elevation: 2 },
  videoThumb: { width: 72, height: 54, backgroundColor: '#FFF3CD', borderRadius: 10, justifyContent: 'center', alignItems: 'center', marginRight: 12 },
  videoInfo: { flex: 1 },
  videoTitle: { fontSize: 14, fontWeight: '600', color: Colors.text.primary },
  videoDesc: { fontSize: 12, color: Colors.text.light, marginTop: 3 },
  videoDuration: { fontSize: 12, color: Colors.accent, marginTop: 3, fontWeight: '600' },
});
